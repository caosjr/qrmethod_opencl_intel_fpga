int dot_product(int* restrict a, unsigned int k, unsigned int j){
        int m = 0, TAM2 = 2209;
        int sum = 0;
        #pragma unroll
        for (m = 0; m < TAM2; m += 47) {
...
void qr_method(global int* restrict dataQ, global int* restrict dataR){
    ...
    int r2[TAM];
    int rn[TAM2];
    int localQ[TAM2], localR[TAM2], Q_column_buffer[TAM];
